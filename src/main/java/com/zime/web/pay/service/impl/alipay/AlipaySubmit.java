package com.zime.web.pay.service.impl.alipay;
...
public class AlipaySubmit {
  ...
  private static String buildRequestMysign(Map<String, String> sPara) {
    ...
    String mysign = "";
    mysign = MD5.sign(prestr, AliPayConfig.md5Key, AliPayConfig.CHAESET);
    return mysign;
  }
  ...
  public static String buildRequest(Map<String, String> sParaTemp) {
    ...
    sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW + "_input_charset="
        + AliPayConfig.CHAESET + "\" method=\"get\">");
    ...
    sbHtml.append("<input type=\"submit\" value=\"ensure\" style=\"display:none;\"></form>");
